# LLM-CPlusPlus-Alpha
A very basic LLM written in C++ by me few months ago, as a experiment. I've been figuring out how to make GPT completely from scratch all by myself and I have fun doing so. Please do not tell me how to make it better nor give any tips, I want it to remain a fun creative challenge for me.
...
When generating text, it looks at last word that appeared, finds it in the model folder and chooses a random word from the text file named after it. This way, it chooses the next word to write based on highest probability of what that word should be, as learned from training material.
...
If it does not know a word (does not have it in its database), it will choose the next word fully randomly.
